...
import 'package:today_news/features/newsPosts/presentation/pages/news_detailes_page.dart';

class NewsPostsWidget extends StatelessWidget {
  final List<Article> articles;
  const NewsPostsWidget({super.key, required this.articles});
              ...
              trailing: InkWell(
                onTap: () {
                  BlocProvider.of<NewspostsBloc>(context)
                      .add(AddINArchiveEvent(article: articles[index]));
                },
                child: Icon(
